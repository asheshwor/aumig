...
#data from: http://www.abs.gov.au/websitedbs/censushome.nsf/home/factsheetsim?opendocument&navpos=450
...
#write map :)
ggsave(gcmap, width=297, height=210, units="mm", filename = "gcmapaulight.pdf", dpi=75)
